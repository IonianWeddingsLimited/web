...
<input type="hidden" name="page" value="bookacallback">
...
<?php echo stripslashes($level1_record[2]); ?> 
	...
	<div class="formheader">
		...
		<h1>Your Call Back Appointment</h1>
	</div>
	<div class="formrow">
		<label class="formlabel" for="weddingquestionnaire_callbackdate">Preferred days or dates for your call back</label>
		<div class="formelement">
	...
	<div class="formrow">
		<label class="formlabel" for="weddingquestionnaire_callbacktimeID">Preferred times for your call back</label>
		<div class="formelement">
