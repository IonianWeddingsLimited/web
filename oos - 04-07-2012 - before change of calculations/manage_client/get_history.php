...
<option value=\"Cancelled\" $s5>Cancelled</option></select> </div>
...
<?php if($list) { ?>
[ <a href="<?php echo $siet_url; ?>/oos/download-all-invoices.php?client_id=<?php echo $_POST["client_id"]; ?>">Download All Invoices</a> ]
<?php } ?>
