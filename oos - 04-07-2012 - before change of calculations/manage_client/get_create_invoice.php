...
if($menu_option_record[13] == "Amount" and $menu_option_record[12] >= 1 and $menu_option_record[14] == "Net") { 
$iw_cost = $menu_option_record[4] - $menu_option_record[12];
} elseif($menu_option_record[13] == "Percent" and $menu_option_record[12] >= 1) { 
...
if($menu_option_record[13] == "Amount" and $menu_option_record[12] >= 1 and $menu_option_record[14] == "Gross") { 
$iw_cost = $iw_cost - abs($menu_option_record[12] / $menu_option_record[2]);
} 
...
if($menu_option_record[13] == "Amount" and $menu_option_record[12] >= 1 and $menu_option_record[14] == "Gross") { 
$total_iw_cost = $total_iw_cost_orig - $menu_option_record[12];
} elseif($menu_option_record[13] == "Percent" and $menu_option_record[12] >= 1) { 
$percent_value = ($total_iw_cost_orig / 100);
$total_iw_cost = $total_iw_cost_orig - ($percent_value * $menu_option_record[12]);
} else {
...
if($extra_record[13] == "Amount" and $extra_record[12] >= 1 and $extra_record[14] == "Net") { 
...
if($extra_record[13] == "Amount" and $extra_record[12] >= 1 and $extra_record[14] == "Gross") { 
$iw_cost = $iw_cost - abs($extra_record[12] / $extra_record[2]);
} 
...
if($extra_record[13] == "Amount" and $extra_record[12] >= 1 and $extra_record[14] == "Gross") { 
$total_iw_cost = $total_iw_cost_orig - $extra_record[12];
} elseif($extra_record[13] == "Percent" and $extra_record[12] >= 1) { 
$percent_value = ($total_iw_cost_orig / 100);
$total_iw_cost = $total_iw_cost_orig - ($percent_value * $extra_record[12]);
} else {
$total_iw_cost = $total_iw_cost_orig;
}
