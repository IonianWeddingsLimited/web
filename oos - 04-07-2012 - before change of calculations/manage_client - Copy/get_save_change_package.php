...
$package_info_result = $sql_command->select($database_order_history,"id,name,cost,iw_cost,currency,d_value,d_type","WHERE order_id='".addslashes($_POST["invoice_id"])."' and item_type='Package'");
$package_info_record = $sql_command->result($package_info_result);
...
if($menu_option_record[12] == "Amount" and $menu_option_record[11] >= 1) { 
...
if($extra_record[12] == "Amount" and $extra_record[11] >= 1) { 
