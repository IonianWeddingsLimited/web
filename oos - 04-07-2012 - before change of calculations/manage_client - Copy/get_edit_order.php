...
$get_checked_result = $sql_command->select($database_order_history,"qty,d_value,d_type","WHERE order_id='".addslashes($_GET["invoice_id"])."' and type_id='".addslashes($menu_option_record[0])."' and item_type='Menu' and type='Extra' and status='Outstanding'");
...
$get_checked_result = $sql_command->select($database_order_history,"qty,d_value,d_type","WHERE order_id='".addslashes($_GET["invoice_id"])."' and type_id='".addslashes($extra_record[0])."' and item_type='Extra' and type='Extra'  and status='Outstanding'");
$get_checked_record = $sql_command->result($get_checked_result);
...
$get_checked_result = $sql_command->select($database_order_history,"qty,d_value,d_type","WHERE order_id='".addslashes($_GET["invoice_id"])."' and type_id='".addslashes($service_record[0])."' and item_type='Service Fee'  and status='Outstanding'");
$get_checked_record = $sql_command->result($get_checked_result);
...
<div style=\"float:left; width:400px; margin:5px;\">".stripslashes($menu_record[6])."</div>
...
<div style=\"float:left; width:400px; margin:5px;\">".stripslashes($package_extra_record[2])."</div>
<div style=\"float:left; width:60px; margin:5px;\">$curreny 0</div>
<div style=\"float:left; width:60px; margin:5px;\">$curreny 0</div>
<div style=\"clear:left;\"></div>";
}
...
<div style=\"float:left; width:400px; margin:5px;\">".stripslashes($package_service_record[2])."</div>
...
<div style="float:left; width:380px; margin:5px;"><?php echo stripslashes($package_info_record[1]); ?></div>
