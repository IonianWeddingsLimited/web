...
<option value="Admin" <?php if($record[3] == "Admin") { echo "selected=\"selected\""; } ?>>Admin</option>
<option value="User" <?php if($record[3] == "User") { echo "selected=\"selected\""; } ?>>User</option>
</select>
</div>
<div style="clear:left;"></div>
...
<form action="<?php echo $site_url; ?>/admin/update-user.php" method="POST" name="testimonial">
