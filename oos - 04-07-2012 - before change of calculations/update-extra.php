...
$sql_command->update($database_package_extras,"supplier_id='".addslashes($_POST["supplier"])."'","supplier_id='".addslashes($_POST["supplier_id"])."' and id='".addslashes($_POST["id"])."'");
$sql_command->update($database_package_extras,"category_id='".addslashes($_POST["category"])."'","supplier_id='".addslashes($_POST["supplier_id"])."' and id='".addslashes($_POST["id"])."'");
$sql_command->update($database_package_extras,"island_id='".addslashes($_POST["island"])."'","supplier_id='".addslashes($_POST["supplier_id"])."' and id='".addslashes($_POST["id"])."'");
$sql_command->update($database_package_extras,"product_name='".addslashes($_POST["extraname"])."'","supplier_id='".addslashes($_POST["supplier_id"])."' and id='".addslashes($_POST["id"])."'");
$sql_command->update($database_package_extras,"currency='".addslashes($_POST["currency"])."'","supplier_id='".addslashes($_POST["supplier_id"])."' and id='".addslashes($_POST["id"])."'");
$sql_command->update($database_package_extras,"cost='".addslashes($_POST["cost"])."'","supplier_id='".addslashes($_POST["supplier_id"])."' and id='".addslashes($_POST["id"])."'");
$sql_command->update($database_package_extras,"iw_cost='".addslashes($_POST["iw_cost"])."'","supplier_id='".addslashes($_POST["supplier_id"])."' and id='".addslashes($_POST["id"])."'");
$sql_command->update($database_package_extras,"notes='".addslashes($_POST["notes"])."'","supplier_id='".addslashes($_POST["supplier_id"])."' and id='".addslashes($_POST["id"])."'");
...
<div style="float:right; margin-top:10px; margin-right:10px;"><input type="button" name="" value="Back" onclick="window.location='<?php echo $site_url; ?>/oos/update-extra.php'"></div>
...
$result = $sql_command->select("$database_package_extras,$database_category_extras","$database_package_extras.id,
							   ...
							   $database_package_extras.supplier_id='".addslashes($_GET["supplier_id"])."' 
