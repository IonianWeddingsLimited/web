...
$get_template->errorHTML("Add Ceremony and Reception","Oops!","$error","Link","oos/add-ceremony-reception.php");
$get_template->bottomHTML();
$sql_command->close();
}

$cols = "island_id,ceremony_name";

$values = "'".addslashes($_POST["island_id"])."',
'".addslashes($_POST["ceremony_name"])."'";
...
<p>The ceremony and reception has now been added</p>
<?
$get_template->bottomHTML();
$sql_command->close();
...
<div style="float:left; margin:5px;">	<input type="text" name="ceremony_name" style="width:240px;"/> *</div>
<div style="clear:left;"></div>

<p><hr /></p>

<div style="float:left; width:160px; margin:5px;"><b>Reception Name</b></div>
<div style="float:left; margin:5px;"><input type="text" name="reception_1" style="width:240px;"/> *</div>
<div style="clear:left;"></div>
...
<div style="float:right; width:180px; margin:5px;"><input type="button" value="Add Another Reception" onclick="addElement();"></div>
