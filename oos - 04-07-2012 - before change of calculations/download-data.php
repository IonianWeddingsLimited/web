...
$result = $sql_command->select($database_info_wedding_questionnaire,"id,
							   bride_firstname,
							   bride_lastname,
							   bride_country,
							   bride_email,
...
fputcsv($output, array($record[0], $date2, $couple_names, $couple_names2, $record[4], $record[16], $record[17], $island_html, $date, $record[9], $record[10], $record[11], $callback, $record[3]));	
}
...
fputcsv($output, array($record[0],$date, $name,$record[3],$record[4],$record[5],$record[6],$record[7],$record[8],$record[17],$record[9],$record[10],$record[11],$record[13],$record[14],$record[15],$record[16]));
}
...
$name = $record[1]." ".$record[2];
$date = @date("d-m-Y",$record[12]);
fputcsv($output, array($record[0],$date, $name,$record[3],$record[4],$record[5],$record[6],$record[7],$record[8],$record[17],$record[9],$record[10],$record[11],$record[13],$record[14],$record[15]));
}
...
$name = $record[1]." ".$record[2];
$date = @date("d-m-Y",$record[12]);
fputcsv($output, array($record[0], $date, $record[14], $name, $record[3], $record[4], $record[5], $record[6], $record[7], $record[8], $record[17], $record[9], $record[10], $record[11], $record[13]));
}
}
