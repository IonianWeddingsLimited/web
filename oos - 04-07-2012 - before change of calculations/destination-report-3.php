...
&pound; <?php if($april_total_bookings > 0) { $april_cost_average = $april_cost / $april_total_bookings; } else { $april_cost_average = 0; }  echo number_format($april_cost_average,2); ?></div>
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($april_total_bookings > 0) { $april_iwcost_average = $april_iwcost / $april_total_bookings; } else { $april_iwcost_average = 0; } echo number_format($april_iwcost_average,2); ?></div>
<div style="clear:left;"></div>
...
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($may_total_bookings > 0) { $may_cost_average = $may_cost / $may_total_bookings; } else { $may_cost_average = 0; }  echo number_format($may_cost_average,2); ?></div>
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($may_total_bookings > 0) { $may_iwcost_average = $may_iwcost / $may_total_bookings; } else { $may_iwcost_average = 0; } echo number_format($may_iwcost_average,2); ?></div>
<div style="clear:left;"></div>
...
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($june_total_bookings > 0) { $june_cost_average = $june_cost / $june_total_bookings; } else { $june_cost_average = 0; }  echo number_format($june_cost_average,2); ?></div>
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($june_total_bookings > 0) { $june_iwcost_average = $june_iwcost / $june_total_bookings; } else { $june_iwcost_average = 0; } echo number_format($june_iwcost_average,2); ?></div>
<div style="clear:left;"></div>
...
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($july_total_bookings > 0) { $july_cost_average = $july_cost / $july_total_bookings; } else { $july_cost_average = 0; }  echo number_format($july_cost_average,2); ?></div>
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($july_total_bookings > 0) { $july_iwcost_average = $july_iwcost / $july_total_bookings; } else { $july_iwcost_average = 0; } echo number_format($july_iwcost_average,2); ?></div>
<div style="clear:left;"></div>
...
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($august_total_bookings > 0) { $august_cost_average = $august_cost / $august_total_bookings; } else { $august_cost_average = 0; }  echo number_format($august_cost_average,2); ?></div>
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($august_total_bookings > 0) { $august_iwcost_average = $august_iwcost / $august_total_bookings; } else { $august_iwcost_average = 0; } echo number_format($august_iwcost_average,2); ?></div>
<div style="clear:left;"></div>
...
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($september_total_bookings > 0) { $september_cost_average = $september_cost / $september_total_bookings; } else { $september_cost_average = 0; }  echo number_format($september_cost_average,2); ?></div>
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($september_total_bookings > 0) {$september_iwcost_average = $september_iwcost / $september_total_bookings; } else { $september_iwcost_average = 0; } echo number_format($september_iwcost_average,2); ?></div>
<div style="clear:left;"></div>
...
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($october_total_bookings > 0) { $october_cost_average = $october_cost / $october_total_bookings; } else { $october_cost_average = 0; }  echo number_format($october_cost_average,2); ?></div>
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($october_total_bookings > 0) { $october_iwcost_average = $october_iwcost / $october_total_bookings; } else { $october_iwcost_average = 0; } echo number_format($october_iwcost_average,2); ?></div>
<div style="clear:left;"></div>
...
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($november_total_bookings > 0) { $november_cost_average = $november_cost / $november_total_bookings; } else { $november_cost_average = 0; }  echo number_format($november_cost_average,2); ?></div>
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($november_total_bookings > 0) { $november_iwcost_average = $november_iwcost / $november_total_bookings; } else { $november_iwcost_average = 0; } echo number_format($november_iwcost_average,2); ?></div>
<div style="clear:left;"></div>
...
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($december_total_bookings > 0) { $december_cost_average = $december_cost / $december_total_bookings; } else { $december_cost_average = 0; }  echo number_format($december_cost_average,2); ?></div>
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($december_total_bookings > 0) { $december_iwcost_average = $december_iwcost / $december_total_bookings; } else { $december_iwcost_average = 0; } echo number_format($december_iwcost_average,2); ?></div>
<div style="clear:left;"></div>
...
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($january_total_bookings > 0) { $january_cost_average = $january_cost / $january_total_bookings; } else { $january_cost_average = 0; }  echo number_format($january_cost_average,2); ?></div>
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($january_total_bookings > 0) { $january_iwcost_average = $january_iwcost / $january_total_bookings; } else { $january_iwcost_average = 0; } echo number_format($january_iwcost_average,2); ?></div>
<div style="clear:left;"></div>
...
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($february_total_bookings > 0) { $february_cost_average = $february_cost / $february_total_bookings; } else { $february_cost_average = 0; }  echo number_format($february_cost_average,2); ?></div>
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($february_total_bookings > 0) { $february_iwcost_average = $february_iwcost / $february_total_bookings; } else { $february_iwcost_average = 0; } echo number_format($february_iwcost_average,2); ?></div>
<div style="clear:left;"></div>
...
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($march_total_bookings > 0) { $march_cost_average = $march_cost / $march_total_bookings; } else { $march_cost_average = 0; }  echo number_format($march_cost_average,2); ?></div>
<div style="float:left; width:150px; margin:5px;">
&pound; <?php if($march_total_bookings > 0) { $march_iwcost_average = $march_iwcost / $march_total_bookings; } else { $march_iwcost_average = 0; } echo number_format($march_iwcost_average,2); ?></div>
<div style="clear:left;"></div>
<p><hr /></p>
...
<div style="float:left; width:150px; margin:5px;"><?php echo $april_total_bookings+$may_total_bookings+$june_total_bookings+$july_total_bookings+$august_total_bookings+$september_total_bookings+$october_total_bookings+$november_total_bookings+$december_total_bookings+$janaury_total_bookings+$february_total_bookings+$march_total_bookings; ?></div>
<div style="float:left; width:150px; margin:5px;">&pound; <?php echo number_format($april_cost_average+$may_cost_average+$june_cost_average+$july_cost_average+$august_cost_average+$september_cost_average+$october_cost_average+$november_cost_average+$december_cost_average+$january_cost_average+$february_cost_average+$march_cost_average,2); ?></div>
<div style="float:left; width:150px; margin:5px;">&pound; <?php echo number_format($april_iwcost_average+$may_iwcost_average+$june_iwcost_average+$july_iwcost_average+$august_iwcost_average+$september_iwcost_average+$october_iwcost_average+$november_iwcost_average+$december_iwcost_average+$january_iwcost_average+$february_iwcost_average+$march_iwcost_average,2); ?></div>
