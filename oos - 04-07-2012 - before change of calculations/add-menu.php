...
if(!$_POST["cost_1"]) { $error .= "Missing Cost<br>"; }
if(!$_POST["iw_cost_1"]) { $error .= "Missing IW Cost<br>"; }
...
$cols = "supplier_id,venue_id,island_id,menu_name_iw,local_tax_percent,discount_at,discount_percent,timestamp";
