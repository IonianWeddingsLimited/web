...
if(!$_POST["yourname"]) { $error .= "Missing First Name<br>"; }
if(!$_POST["lastname"]) { $error .= "Missing Last Name<br>"; }
//if(!$_POST["iwcuid"]) { $error .= "Missing IWCUID<br>"; }
if(!$_POST["dateofwedding"]) { $error .= "Missing Date of Wedding<br>"; }
...
if(!$_POST["location"]) { $error .= "Missing Location<br>"; }
if(!$_POST["venues"]) { $error .= "Missing Venues<br>"; }
...
if($_POST["feature_testimonials"] == "") { $_POST["feature_testimonials"] = "No"; }
if($_POST["feature_website"] == "") { $_POST["feature_website"] = "No"; }
if($_POST["feature_facebook"] == "") { $_POST["feature_facebook"] = "No"; }
if($_POST["privacypolicy"] == "") { $_POST["privacypolicy"] = "No"; }
if($_POST["termsandconditions"] == "") { $_POST["termsandconditions"] = "No"; }


$_SESSION["lastname"] = $_POST["lastname"];
$_SESSION["iwcuid"] = $_POST["iwcuid"];
$_SESSION["dateofwedding"] = $_POST["dateofwedding"];
$_SESSION["location"] = $_POST["location"];
$_SESSION["venues"] = $_POST["venues"];
...
$_SESSION["wedding_planner_comments"] = $_POST["wedding_planner_comments"];
$_SESSION["wedding_coordinator"] = $_POST["wedding_coordinator"];
$_SESSION["wedding_coordinator_comments"] = $_POST["wedding_coordinator_comments"];
...
$extra ="<br>";
$message .= "Name: ".$_POST["yourname"]." ".$_POST["lastname"].$extra;
$message .= "IWCUID: ".$_POST["iwcuid"].$extra;
$message .= "Date of Wedding: ".$_POST["dateofwedding"].$extra;
$message .= "Location: ".$_POST["location"].$extra;
$message .= "Venues: ".$_POST["venues"].$extra;
...
$message .= "Wedding planner UK: ". $_POST["wedding_planner"].$extra;
$message .= "Wedding planner comments: ". $_POST["wedding_planner_comments"].$extra;
$message .= "Wedding co-ordinator at destination: ". $_POST["wedding_coordinator"].$extra;
$message .= "Wedding co-ordinator comments: ". $_POST["wedding_coordinator_comments"].$extra;
...
$message .= "Recommend to another couple: ". $_POST["privacypolicy"].$extra;
$message .= "Appear in publications: ". $_POST["termsandconditions"].$extra;
$message .= "IP Address: ".$_SERVER["REMOTE_ADDR"].$extra;
...
//$mail->AddTo("gordon@zestisbest.net");	// Name is optional
...
$cols	=	"yourname
			...
			,paperwork
			,wedding_planner
			,wedding_planner_comments
			,wedding_coordinator
			,wedding_coordinator_comments
			,wedding_location
			,reception_location
			,overall_service
			,book_accommodation_with
			,wedding_insurance
			,how_many_guests
			,comments
...
$values	=	"'".addslashes($_POST["yourname"])."',
			...
			'".addslashes($_POST["wedding_planner_comments"])."',
			'".addslashes($_POST["wedding_coordinator"])."',
			'".addslashes($_POST["wedding_coordinator_comments"])."',
			...
			'".addslashes($_POST["dateofwedding"])."',
			'".addslashes($_POST["location"])."',
			'".addslashes($_POST["venues"])."',
...
$_SESSION["wedding_planner_comments"] = "";
$_SESSION["wedding_coordinator"] = "";
$_SESSION["wedding_coordinator_comments"] = "";
...
foreach($destination_row as $destination_record) {
$idline2 = $destination_record[0];
if($_POST[$idline2]) {
$message .= stripslashes($destination_record[1]).": ".$_POST[$idline2].$extra;
} else {
