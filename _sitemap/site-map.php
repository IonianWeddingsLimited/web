...
$level1_result = $sql_command->select($database_navigation,"id,page_name,page_link,external_link,external_url","WHERE page_link='navigation_header' or page_link='navigation_footer' and hide_page='No' ORDER BY displayorder");
$level1_row = $sql_command->results($level1_result);
	
foreach($level1_row as $level1_record) {

if($level1_record[2] == "navigation_header") {
$level1_record[1] = "Header";
} 
if($level1_record[2] == "navigation_footer") {
$level1_record[1] = "Footer";
}

echo "<!--<h3>".stripslashes($level1_record[1])."</h3><ul>";
...
if($level3_row[0][0]) {
echo "<li><a href=\"$site_url/".stripslashes($level2_record[2])."/\" target=\"_self\" title=\"".stripslashes($level2_record[1])."\"><strong>".stripslashes($level2_record[1])."</strong></a><ul>\n";	
...
if($level4_row[0][0]) {
echo "<li><a href=\"$site_url/".stripslashes($level2_record[2])."/".stripslashes($level3_record[2])."/\" target=\"_self\" title=\"".stripslashes($level3_record[1])."\">".stripslashes($level3_record[1])."</a><ul>\n";	
...
echo "<li><a href=\"$site_url/".stripslashes($level2_record[2])."/".stripslashes($level3_record[2])."/".stripslashes($level4_record[2])."/\" target=\"_self\" title=\"".stripslashes($level4_record[1])."\">".stripslashes($level4_record[1])."</a></li>\n";	
}
}
...
echo "<li><a href=\"$site_url/".stripslashes($level2_record[2])."/".stripslashes($level3_record[2])."/\" target=\"_self\" title=\"".stripslashes($level3_record[1])."\">".stripslashes($level3_record[1])."</a></li>\n";	
}
}
// end internal link level 4
...
echo "<li><a href=\"$site_url/".stripslashes($level2_record[2])."/\" target=\"_self\" title=\"".stripslashes($level2_record[1])."\">".stripslashes($level2_record[1])."</a></li>\n";	
}
}
...
$level1_result = $sql_command->select($database_navigation,"id,page_name,page_link,external_link,external_url","WHERE parent_id='0' and id!='115' and  page_link!='navigation_header' and page_link!='navigation_footer' and hide_page='No' ORDER BY displayorder");
$level1_row = $sql_command->results($level1_result);
