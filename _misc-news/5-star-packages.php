...
$image_line = "<div style=\"float:right; background-color:#f9eed8; margin-bottom:10px;\"><div class=\"hero_".$record[6]."\"></div></div><div class=\"clear;\"></div>"; 
?>
...
$result = $sql_command->select($database_news,"title,tagline,content,imagename,timestamp,short_url,external_link,overrule,xml_file_name,id","WHERE type='5 Star Package' and (overrule='Yes' or (timestamp > $time and overrule='No')) ORDER BY timestamp DESC LIMIT $limitbottom,$per_page");
...
$image_line = "<div class=\"accordianimage\" style=\"background-color:#f9eed8; margin-bottom:10px;\"><div class=\"hero_".$record[9]."\"></div></div>"; 
} else {	
...
$read_more = "<div onclick=\"return popitup('$site_url/5-star-packages/article/$record[5]')\"><h4><a href=\"$site_url/5-star-packages/article/$record[5]\">Read more &gt;</a></h4></div>";
...
$number_rows = $sql_command->count_rows($database_news,"id","type='5 Star Package' and (overrule='Yes' or (timestamp > $time and overrule='No')) ORDER BY timestamp DESC");
...
$pagehtml .= "<li class=\"paginationlink\"><a href=\"$site_url/5-star-packages/$eachpage\" target=\"_self\" title=\"$eachpage\">$eachpage</a></li>";
}
}
...
if($page != 1) {
$previd = $page-1;
$prev_link = "<li class=\"previouslink\"><a href=\"$site_url/5-star-packages/".$previd."\" target=\"_self\" title=\"&lt; Previous;\">&lt; Previous</a></li>";
}

if($page !=$newpage) {
$nextid = $page+1;
$next_link = "<li class=\"nextlink\"><a href=\"$site_url/5-star-packages/".$nextid."\" target=\"_self\" title=\"Next &gt;\">Next &gt;</a></li>";
}
