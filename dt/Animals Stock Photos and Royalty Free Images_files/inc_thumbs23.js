...
function trailOn4(thumbimg,imgtitle,username,imgid,imgsize,credit,level,thw,thh,smallmedium,smallThumbPath){
	...
	htm+='<div style="border: 10px solid #4c4843; width:'+divthw+'px;height:100%;position:absolute; display:table; z-index:49; ">';
		htm+='<div style="width:'+thw+'px;">';
			...
			htm+='<div style="border-width:0px;margin:0px;padding:0px;z-index:52;position:absolute;width:'+thw+'px;top:'+topx+'px;text-align: center;">';
			htm+='</div>';
			htm+='<div style="border-width:0px;margin:0px;padding:0px;z-index:53;position:absolute;width:'+divthw+'px;">';
				htm+='<div style="border: 1px solid #ffffff;width:'+divthw+'px;background-color: #ffffff;">';
				
				htm+='<div name="btcontainer" id="btcontainer"><div class="mejs-mediaelement" ><video poster="'+thumbimgprev+'" id="sampleMovie" width="'+divthw+'" height="100%" preload="none" autoplay>';
				htm+='<source src="http://thumbs.dreamstime.com/videothumb_'+Math.floor(imgid/10000)+'/'+imgid+'.mp4" type=\'video/mp4; codecs="avc1.42E01E, mp4a.40.2"\'  />';
				htm+='<source src="http://thumbs.dreamstime.com/videothumb_'+Math.floor(imgid/10000)+'/'+imgid+'.webm" type=\'video/webm; codecs="vp8, vorbis"\'  />';
				
				htm+='<object width="'+thw+'" height="'+thh+'" type="application/x-shockwave-flash" data="flashmediaelement.swf">';
				htm+='<param name="movie" value="http://fpdownload.adobe.com/strobe/FlashMediaPlayback.swf"></param>';
				htm+='<param name="flashvars" value="src=http%3A%2F%2Fthumbs.dreamstime.com%2Fvideothumb_'+Math.floor(imgid/10000)+'%2F'+imgid+'.flv&autoPlay=true"></param>';
				htm+='<param name="allowFullScreen" value="true"></param>';
				htm+='<param name="allowscriptaccess" value="always"></param>';
				htm+='<param name="autoStart" value="1"></param>';
				htm+='<param name="autoPlay" value="1"></param>';
				htm+='<param name="wmode" value="transparent"></param>';
				
				htm+='<embed src="http://fpdownload.adobe.com/strobe/FlashMediaPlayback.swf"';
				 htm+=' type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" autoPlay="true" wmode="transparent"';
				 htm+='width="'+thw+'" height="'+thh+'" flashvars="src=http%3A%2F%2Fthumbs.dreamstime.com%2Fvideothumb_'+Math.floor(imgid/10000)+'%2F'+imgid+'.flv&autoPlay=true">';
				htm+='</embed>';
	...
	gettrailobject().style.zIndex=99;
	if (document.getElementById)
		document.getElementById('btcontainer').src = htm;
	else if (document.all)
		document.all.btcontainer.src = htm;
	gettrailobj().visibility="visible";
	divw = parseInt(thw)+25;
	divh = parseInt(thh)+130;
	mm_hoverThumb=1;
