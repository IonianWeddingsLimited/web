...
$result = $sql_command->select($database_news,"title,tagline,content,imagename,timestamp,short_url,external_link","WHERE type='Press' ORDER BY timestamp DESC LIMIT $limitbottom,$per_page");
