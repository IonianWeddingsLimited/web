...
<div style="clear:left;"></div>
<!--<div style="float:left; width:160px; margin:5px;"><b>SEO Url</b></div>
<div style="float:left; margin:5px;"><input type="text" name="page_link" style="width:300px;" value="<?php echo stripslashes($record[4]); ?>" /></div>
<div style="clear:left;"></div>-->
