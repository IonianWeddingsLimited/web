...
if(!$_GET["id"]) {
header("Location: $site_url/admin/wedding-questionaire.php");
$sql_command->close();
}
...
<div>
<form action="<?php echo $site_url; ?>/admin/wedding-questionaire.php" method="POST" class="pageform">
...
<?php echo stripslashes($record[22]); ?>
	...
	<div class="formheader" style="width:550px;">
		<h1>Comments</h1>
...
<form action="<?php echo $site_url; ?>/admin/wedding-questionaire.php" method="POST">
<input type="hidden" name="id" value="<?php echo stripslashes($record[0]); ?>" />
...
$get_template->topHTML();
?>
<h1>Questionaire Deleted</h1>

<p>The questionaire has now been deleted</p>
<?
$get_template->bottomHTML();
$sql_command->close();	
...
<form action="<?php echo $site_url; ?>/admin/wedding-questionaire.php" method="get">
