...
$cols = "contact_title,contact_firstname,contact_surname,contact_email,contact_tel,company_name,address_1,address_2,address_3,address_town,address_county,address_country,address_postcode,timestamp,code,deleted";
...
$sql_command->insert($database_client_historyinfo,"client_id,user_id,comment,timestamp,package_id,island_id","'','".$login_record[1]."','Supplier Added (".addslashes($_POST["company"]).")','".$time."','',''");
