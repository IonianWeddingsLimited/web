...
$january_result = $sql_command->select("$database_clients,$database_order_details,$database_customer_invoices",
...
$february_result = $sql_command->select("$database_clients,$database_order_details,$database_customer_invoices",
									"$database_customer_invoices.cost,
									$database_customer_invoices.iw_cost,
									$database_customer_invoices.vat,
									$database_customer_invoices.type,
...
$march_result = $sql_command->select("$database_clients,$database_order_details,$database_customer_invoices",
									"$database_customer_invoices.cost,
									$database_customer_invoices.iw_cost,
									$database_customer_invoices.vat,
									$database_customer_invoices.type,
...
$april_result = $sql_command->select("$database_clients,$database_order_details,$database_customer_invoices",
									"$database_customer_invoices.cost,
									$database_customer_invoices.iw_cost,
									$database_customer_invoices.vat,
									$database_customer_invoices.type,
...
$may_result = $sql_command->select("$database_clients,$database_order_details,$database_customer_invoices",
									"$database_customer_invoices.cost,
									$database_customer_invoices.iw_cost,
									$database_customer_invoices.vat,
									$database_customer_invoices.type,
...
$june_result = $sql_command->select("$database_clients,$database_order_details,$database_customer_invoices",
									"$database_customer_invoices.cost,
									$database_customer_invoices.iw_cost,
									$database_customer_invoices.vat,
									$database_customer_invoices.type,
...
$july_result = $sql_command->select("$database_clients,$database_order_details,$database_customer_invoices",
									"$database_customer_invoices.cost,
									$database_customer_invoices.iw_cost,
									$database_customer_invoices.vat,
									$database_customer_invoices.type,
...
$august_result = $sql_command->select("$database_clients,$database_order_details,$database_customer_invoices",
									"$database_customer_invoices.cost,
									$database_customer_invoices.iw_cost,
									$database_customer_invoices.vat,
									$database_customer_invoices.type,
...
$september_result = $sql_command->select("$database_clients,$database_order_details,$database_customer_invoices",
									"$database_customer_invoices.cost,
									$database_customer_invoices.iw_cost,
									$database_customer_invoices.vat,
									$database_customer_invoices.type,
...
$october_result = $sql_command->select("$database_clients,$database_order_details,$database_customer_invoices",
									"$database_customer_invoices.cost,
									$database_customer_invoices.iw_cost,
									$database_customer_invoices.vat,
									$database_customer_invoices.type,
...
$november_result = $sql_command->select("$database_clients,$database_order_details,$database_customer_invoices",
									"$database_customer_invoices.cost,
									$database_customer_invoices.iw_cost,
									$database_customer_invoices.vat,
									$database_customer_invoices.type,
...
$december_result = $sql_command->select("$database_clients,$database_order_details,$database_customer_invoices",
									"$database_customer_invoices.cost,
									$database_customer_invoices.iw_cost,
									$database_customer_invoices.vat,
									$database_customer_invoices.type,
