...
$get_template->errorHTML("Add Prospect","Oops!","$error","Link","oos/add-prospect.php");
...
$sql_command->update($database_info_contactus,"archive='Yes'","id='".addslashes($_SESSION["prospect_id"])."'");
...
<h1>Add Prospect</h1>
<form action="<?php echo $site_url; ?>/oos/add-prospect.php" method="post" name="client">
