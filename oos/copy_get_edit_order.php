...
foreach($extra_row as $extra_record) {
$hideCheck = $sql_command->count_nrow("notes","notes_id","note_primary_reference = '".addslashes($_GET['invoice_id'])."' AND note_secondary_reference = '".addslashes($extra_record[0])."' AND note_type = 'Hide' AND extra = 'Yes'");
...
$hideCheck = $sql_command->count_nrow("notes","notes_id","note_primary_reference = '".addslashes($_GET['invoice_id'])."' AND note_secondary_reference = '".addslashes($package_extra_record[0])."' AND note_type = 'Hide' AND extra = 'Yes'");
$hideC = ($hideCheck>0) ? "checked=\"checked\"": "";
...
foreach($menu_row as $menu_record) {
$hideCheck = $sql_command->count_nrow("notes","notes_id","note_primary_reference = '".addslashes($_GET['invoice_id'])."' AND note_secondary_reference = '".addslashes($menu_record[0])."' AND note_type = 'Hide' AND extra = 'Yes'");
$hideC = ($hideCheck>0) ? "checked=\"checked\"": "";
...
foreach($package_service_row as $package_service_record) {
	$hideCheck = $sql_command->count_nrow("notes","notes_id","note_primary_reference = '".addslashes($_GET['invoice_id'])."' AND note_secondary_reference = '".addslashes($package_service_record[0])."' AND note_type = 'Hide' AND extra = 'Yes'");
$hideC = ($hideCheck>0) ? "checked=\"checked\"": "";
