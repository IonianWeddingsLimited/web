...
$.get('<?php echo $site_url; ?>/oos/folder-module.php?a=add&dosavefolder=' + encodeURIComponent(dosavefolder) + '&foldername=' + encodeURIComponent(foldername), function(data){
...
<div style="overflow:auto; width:660px; height:570px;"><iframe src="folder-module.php" style="width:660px; height:570px; border:0px;" width="660" height="570" border="0"  frameBorder="0" ></iframe>
</div>
</div><div style="float:left; width:180px; padding:10px; background-color:#ccc; height:640px; font-size:12px;">
<span onclick="subfolder('add');" style="color:#c08827; cursor:pointer;">Add Folder</span> | 
<span onclick="subfolder('edit');" style="color:#c08827; cursor:pointer;">Update Folder</span>
...
$.get('<?php echo $site_url; ?>/oos/folder-module.php?a=ajax&do=add&dosavefolder=' + encodeURIComponent(dosavefolder) + '&foldername=' + encodeURIComponent(foldername), function(data){
$('#updated_message').html('The folder ' + foldername + ' has now been added');
});
}
}
...
<form method="post" action="folder-module.php" enctype="multipart/form-data">
...
<p><a href="folder-module.php">Back</a></p></div>
<?php
} else {
