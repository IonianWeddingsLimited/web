...
$sql_command->update("quotation_history","iw_cost='".addslashes($gross_package_cost)."'","order_id='".addslashes($_GET["invoice_id"])."' and item_type='Package'");
$sql_command->update("quotation_details","package_iw_cost='".addslashes($gross_package_cost)."'","id='".addslashes($_GET["invoice_id"])."'");
...
$sql_command->update("quotation_history","d_='".addslashes($_POST["package_d"])."'","order_id='".addslashes($_POST["invoice_id"])."' and item_type='Package'");
}
...
$sql_command->insert($database_package_extras,$colsadd,$valuesadd);
$maxidadd = $sql_command->maxid($database_package_extras,"id");
$bespoke_h = ($_POST[$bespoke_hide]=="Yes") ? $sql_command->insert("notes","note_primary_reference, note_secondary_reference, note_type, extra","'".addslashes($_POST['invoice_id'])."','".addslashes($maxidadd)."','pHide','Yes'") : $sql_command->delete("notes","note_primary_reference = '".addslashes($_POST['invoice_id'])."' and note_secondary_reference = '".addslashes($maxidadd)."' and note_type='pHide'");
...
''";
$sql_command->insert("quotation_history",$cols,$values);
$include_h = ($_POST[$hide]=="Yes") ? $sql_command->insert("notes","note_primary_reference, note_secondary_reference, note_type, extra","'".addslashes($_POST['invoice_id'])."','".addslashes($menu_option_record[0])."','pHide','Yes'") : $sql_command->delete("notes","note_primary_reference = '".addslashes($_POST['invoice_id'])."' and note_secondary_reference = '".addslashes($menu_option_record[0])."' and note_type='pHide'");
}
}
...
if(abs($_POST[$qty_extra]) != 0) {
	...
	''";
	$sql_command->insert("quotation_history",$cols,$values);	
	$m_dbid = $sql_command->maxid("quotation_history","id");
}
...
if (isset($_POST[$o_supplier]) && isset($_POST[$c_supplier]) && $_POST[$o_supplier] != $_POST[$c_supplier]) {
	...
	$sql_command->update("quotation_history","type_id='".addslashes($maxspidadd)."',code='".addslashes($codeadd)."'","type_id='".addslashes($menu_option_record[0])."' AND order_id='".addslashes($_POST['invoice_id'])."'"); 
}
else { $maxpidadd = $menu_option_record[0]; }

$include_h = ($_POST[$hide_include]=="Yes") ? $sql_command->insert("notes","note_primary_reference, note_secondary_reference, note_type, extra","'".addslashes($_POST['invoice_id'])."','".addslashes($maxspidadd)."','pHide','Yes'") : $sql_command->delete("notes","note_primary_reference = '".addslashes($_POST['invoice_id'])."' and note_secondary_reference = '".addslashes($menu_option_record[0])."' and note_type='pHide'");
	}
}
}	
...
''";
$sql_command->insert("quotation_history",$cols,$values);
$include_h = ($_POST[$hide]=="Yes") ? $sql_command->insert("notes","note_primary_reference, note_secondary_reference, note_type, extra","'".addslashes($_POST['invoice_id'])."','".addslashes($package_extra_record[0])."','pHide','Yes'") : $sql_command->delete("notes","note_primary_reference = '".addslashes($_POST['invoice_id'])."' and note_secondary_reference = '".addslashes($package_extra_record[0])."' and note_type='pHide'");
...
if (isset($_POST[$o_supplier]) && isset($_POST[$c_supplier]) && $_POST[$o_supplier] != $_POST[$c_supplier]) {
	...
	$sql_command->update($database_package_extras,"code='".addslashes($codeadd)."'","id='".$maxspidadd."'");
	$sql_command->update("quotation_history","type_id='".addslashes($maxspidadd)."',code='".addslashes($codeadd)."'","type_id='".addslashes($package_extra_record[0])."' AND order_id='".addslashes($_POST['invoice_id'])."'"); 
}
...
else { $maxpidadd = $package_extra_record[0]; }
...
header("Location: $site_url/oos/manage-prospect.php?a=history&id=".$_POST["client_id"]."&si=".$_POST[$c_supplier]."-".$c_supplier);
$sql_command->close();	
