...
<form action="<?php echo $sit_url; ?>/oos/manage-prospect.php" method="post" id="myform">
...
/* echo "<div style=\"float:left; width:160px; margin:5px;\"><strong>Comments for Prospect Invoice</strong><br /><input type=\"checkbox\" name=\"clientsCShow\" id=\"clientsCShow\" value=\"Yes\" checked/> : Show on Invoice</div>
