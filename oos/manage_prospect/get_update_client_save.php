...
$get_template->errorHTML("Manage Prospect","Oops!","$error","Link","oos/manage-prospect.php?a=view&id=".$_POST["client_id"]);
...
$sql_command->insert($database_client_historyinfo,"client_id,user_id,comment,timestamp,package_id,island_id","'".addslashes($_POST["client_id"])."','".$login_record[1]."','Prospect Details Updated','".$time."','','".addslashes($_POST["destination"])."'");
...
<p>The Prospect has now been updated</p>
<?
	if ($_POST["ctype"]=="1") {
