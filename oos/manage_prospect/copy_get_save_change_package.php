...
$sql_command->update("quotation_history","type_id='".addslashes($_POST["package_id"])."'","order_id='".addslashes($_POST["invoice_id"])."' and item_type='Package'");
$sql_command->update("quotation_history","name='".addslashes($package_info_record[4])." > ".addslashes($package_info_record[3])."'","order_id='".addslashes($_POST["invoice_id"])."' and item_type='Package'");
$sql_command->update("quotation_history","cost='".addslashes($package_info_record[0])."'","order_id='".addslashes($_POST["invoice_id"])."' and item_type='Package'");
$sql_command->update("quotation_history","iw_cost='".addslashes($gross_package_cost)."'","order_id='".addslashes($_POST["invoice_id"])."' and item_type='Package'");


$sql_command->update("quotation_details","package_cost='".addslashes($package_info_record[0])."'","id='".addslashes($_POST["invoice_id"])."'");
$sql_command->update("quotation_details","package_iw_cost='".addslashes($gross_package_cost)."'","id='".addslashes($_POST["invoice_id"])."'");
$sql_command->update("quotation_details","package_id='".addslashes($_POST["package_id"])."'","id='".addslashes($_POST["invoice_id"])."'");
...
$sql_command->delete("quotation_history","order_id='".addslashes($_POST["invoice_id"])."' and item_type='Menu' and type='Included'");
$sql_command->delete("quotation_history","order_id='".addslashes($_POST["invoice_id"])."' and item_type='Extra' and type='Included'");
$sql_command->delete("quotation_history","order_id='".addslashes($_POST["invoice_id"])."' and item_type='Service Fee' and type='Included'");
...
$sql_command->insert($database_client_historyinfo,"client_id,user_id,comment,timestamp,package_id,island_id","'".addslashes($_POST["client_id"])."','".addslashes($login_record[1])."','Package Changed','".$time."','".addslashes($_POST["package_id"])."','".addslashes($package_info_record[6])."'");
