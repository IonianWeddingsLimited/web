...
if ($_POST[$bespoke_hide]=="Yes") {
	$sql_command->insert("notes","note_primary_reference, note_secondary_reference, note_type, extra","'".addslashes($maxid)."','".addslashes($maxidadd)."','pHide','Yes'");
}
else { 
	$sql_command->delete("notes","note_primary_reference = '".addslashes($maxid)."' and note_secondary_reference = '".addslashes($maxidadd)."' and note_type='pHide'");
}
...
$sql_command->insert("quotation_history",$cols,$values);
if ($_POST[$hide]=="Yes") {
	$sql_command->insert("notes","note_primary_reference, note_secondary_reference, note_type, extra","'".addslashes($maxid)."','".addslashes($menu_option_record[0])."','pHide','Yes'");
}
else {
	$sql_command->delete("notes","note_primary_reference = '".addslashes($maxid)."' and note_secondary_reference = '".addslashes($menu_option_record[0])."' and note_type='pHide'");
}
}
...
$sql_command->insert("quotation_history",$cols,$values);
if ($_POST[$hide]=="Yes") {
	$sql_command->insert("notes","note_primary_reference, note_secondary_reference, note_type, extra","'".addslashes($maxid)."','".addslashes($package_extra_record[0])."','pHide','Yes'");
}
else {
	$sql_command->delete("notes","note_primary_reference = '".addslashes($maxid)."' and note_secondary_reference = '".addslashes($package_extra_record[0])."' and note_type='pHide'");
}
}
