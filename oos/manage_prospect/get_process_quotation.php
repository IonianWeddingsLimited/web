...
$sql_command->insert($database_prospect_historyinfo,"client_id,user_id,comment,timestamp,package_id,island_id","'".addslashes($_POST["client_id"])."','".$login_record[1]."','Quotation Created (#".$maxid.")','".$time."','".addslashes($_POST["package_id"])."','".addslashes($package_info_record[6])."'");
...
if ($_POST[$bespoke_hide]=="Yes") {
	$sql_command->insert("notes","note_primary_reference, note_secondary_reference, note_type, extra","'".addslashes($_POST['invoice_id'])."','".addslashes($maxidadd)."','pHide','Yes'");
}
else { 
	$sql_command->delete("notes","note_primary_reference = '".addslashes($_POST['invoice_id'])."' and note_secondary_reference = '".addslashes($maxidadd)."' and note_type='pHide'");
}
...
$sql_command->insert("quotation_history",$cols,$values);
if ($_POST[$hide]=="Yes") {
	$sql_command->insert("notes","note_primary_reference, note_secondary_reference, note_type, extra","'".addslashes($_POST['invoice_id'])."','".addslashes($menu_option_record[0])."','pHide','Yes'");
}
else {
	$sql_command->delete("notes","note_primary_reference = '".addslashes($_POST['invoice_id'])."' and note_secondary_reference = '".addslashes($menu_option_record[0])."' and note_type='pHide'");
}
}
...
$sql_command->insert("quotation_history",$cols,$values);
if ($_POST[$hide]=="Yes") {
	$sql_command->insert("notes","note_primary_reference, note_secondary_reference, note_type, extra","'".addslashes($_POST['invoice_id'])."','".addslashes($package_extra_record[0])."','pHide','Yes'");
}
else {
	$sql_command->delete("notes","note_primary_reference = '".addslashes($_POST['invoice_id'])."' and note_secondary_reference = '".addslashes($package_extra_record[0])."' and note_type='pHide'");
}
}
