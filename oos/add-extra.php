...
$sql_command->insert($database_client_historyinfo,"client_id,user_id,comment,timestamp,package_id,island_id","'','".$login_record[1]."','Extra Added (".addslashes($_POST["extraname"]).")','".$time."','','".addslashes($_POST["island"])."'");
...
$category_list = str_replace("value=\"".$_SESSION["category"]."\"","value=\"".$_SESSION["category"]."\" selected=\"selected\"",$category_list);
