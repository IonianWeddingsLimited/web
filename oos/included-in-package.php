...
//	if ($the_username=="u1") {
		$html_extra2 .= "
		<!--<input type=\"hidden\" name=\"extra_qty_$extra_record[0]\" style=\"width:30px;\" value=\"$qty\">-->
		<div style=\"float:left; width:380px; margin:5px;\">".stripslashes($paragraph)."  (".stripslashes($supplier_record[0]).")</div>
		...
		<div style=\"float:left; width:60px; margin:5px;\"><input type=\"checkbox\" name=\"extra_ip_$extra_record[0]\" value=\"Yes\" $included></div>
		<div style=\"float:left; width:60px; margin:5px;\"><input type=\"checkbox\" name=\"extra_qty_$extra_record[0]\" value=\"1\" $mandatory></div>
...
//	if ($the_username=="u1") {
		$html_menu .= "
		<!--<input type=\"hidden\" name=\"menu_qty_$menu_option_record[0]\" style=\"width:30px;\" value=\"$qty\">-->
		<div style=\"float:left; width:380px; margin:5px;\">".stripslashes($menu_option_record[2])." (".stripslashes($supplier_record[0]).")</div>
		...
		<div style=\"float:left; width:60px; margin:5px;\"><input type=\"checkbox\" name=\"menu_ip_$menu_option_record[0]\" value=\"Yes\" $included></div>
		<div style=\"float:left; width:60px; margin:5px;\"><input type=\"checkbox\" name=\"menu_qty_$menu_option_record[0]\" value=\"1\" $mandatory></div>
		<div style=\"clear:left;\"></div>";
//	} else {
//		$html_menu .= "
//		<input type=\"hidden\" name=\"menu_qty_$menu_option_record[0]\" style=\"width:30px;\" value=\"$qty\">
...
//	if ($the_username=="u1") {
		$html_service .= "
		<!--<input type=\"hidden\" name=\"service_qty_$service_record[0]\" style=\"width:30px;\" value=\"$qty\">-->
		<div style=\"float:left; width:380px; margin:5px;\">".stripslashes($paragraph)."  (".stripslashes($supplier_record[0]).")</div>
		...
		<div style=\"float:left; width:60px; margin:5px;\"><input type=\"checkbox\" name=\"service_ip_$service_record[0]\" value=\"Yes\" $included></div>
		<div style=\"float:left; width:60px; margin:5px;\"><input type=\"checkbox\" name=\"service_qty_$service_record[0]\" value=\"1\" $mandatory></div>
		<div style=\"clear:left;\"></div>";
//	} else {
//		$html_service .= "
//		<input type=\"hidden\" name=\"service_qty_$service_record[0]\" style=\"width:30px;\" value=\"$qty\">
...
<div style="float:left; width:60px; margin:5px;"><strong>Include<br />In AI</strong></div>
<?
//if ($the_username=="u1") {
?>
<div style="float:left; width:60px; margin:5px; "><strong>Mandatory</strong></div>
<?
//}
?>
<div style="clear:left;"></div>
