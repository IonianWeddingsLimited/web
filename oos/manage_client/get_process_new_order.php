...
$sql_command->insert($database_package_extras,$colsadd,$valuesadd);
$maxidadd = $sql_command->maxid($database_package_extras,"id");
$bespoke_h = ($bespoke_hide=="Yes") ? $sql_command->insert("notes","note_primary_reference, note_secondary_reference, note_type, note, extra","'".addslashes($_POST['invoice_id'])."','".addslashes($maxidadd)."','Hide','','Yes'") : $sql_command->delete("notes","note_primary_reference = '".addslashes($_POST['invoice_id'])."' and note_secondary_reference = '".addslashes($maxidadd)."' and note_type='Hide'");
...
''";
$sql_command->insert($database_order_history,$cols,$values);
$include_h = ($_POST[$hide]=="Yes") ? $sql_command->insert("notes","note_primary_reference, note_secondary_reference, note_type, note, extra","'".addslashes($_POST['invoice_id'])."','".addslashes($menu_option_record[0])."','Hide','','Yes'") : $sql_command->delete("notes","note_primary_reference = '".addslashes($_POST['invoice_id'])."' and note_secondary_reference = '".addslashes($menu_option_record[0])."' and note_type='Hide'");
}
...
''";
$sql_command->insert($database_order_history,$cols,$values);
$include_h = ($hide=="Yes") ? $sql_command->insert("notes","note_primary_reference, note_secondary_reference, note_type, note, extra","'".addslashes($_POST['invoice_id'])."','".addslashes($package_extra_record[0])."','Hide','','Yes'") : $sql_command->delete("notes","note_primary_reference = '".addslashes($_POST['invoice_id'])."' and note_secondary_reference = '".addslashes($package_extra_record[0])."' and note_type='Hide'");
}
