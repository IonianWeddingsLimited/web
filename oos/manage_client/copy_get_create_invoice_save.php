...
$get_template->errorHTML("Manage Client","Oops!","$error","Link","oos/manage-client.php?a=create-invoice&id=".$_POST["client_id"]."&invoice_id=".$_POST["invoice_id"]);
...
$sql_command->insert($database_customer_invoices,$cols,"'".addslashes($_POST["invoice_id"])."','','','20.00','Quotation','$time','Order','','No','".addslashes($_POST["exchange_rate"])."'");
...
$package_option_result = $sql_command->select("$database_order_history,$database_package_info,$database_packages","$database_order_history.id,
										   ...
										   $database_order_history.d_,$database_order_history.code","WHERE 
