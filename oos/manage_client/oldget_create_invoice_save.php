...
$sql_command->insert($database_customer_invoices,$cols,"'".addslashes($_POST["invoice_id"])."','','','20.00','Quotation','$time','Order','','No'");
...
if($order_record[17] == "Amount" and $order_record[16] >= 0.01) {
$adjustment_iw = $order_record[6] + $order_record[16];
} elseif($order_record[17] == "Percent" and $order_record[16] >= 0.01) { 
...
$order_result2 = $sql_command->select($database_order_history,"*","WHERE order_id='".addslashes($_POST["invoice_id"])."' and type='Included'");
...
if($order_record2[17] == "Amount" and $order_record2[16] >= 0.01) {
$adjustment_iw = $order_record2[6] + $order_record2[16];
} elseif($order_record2[17] == "Percent" and $order_record2[16] >= 0.01) { 
...
$sql_command->insert($database_invoice_history,$invoice_history_cols,$values);
$sql_command->update($database_order_history,"status='Invoice Issued'","order_id='".addslashes($_POST["invoice_id"])."' and id='".$order_record2[0]."'");
$sql_command->update($database_order_history,"exchange_rate='".addslashes($_POST["exchange_rate"])."'","order_id='".addslashes($_POST["invoice_id"])."' and id='".$order_record2[0]."'");
$sql_command->update($database_order_history,"invoice_id='".$maxid."'","order_id='".addslashes($_POST["invoice_id"])."' and id='".$order_record2[0]."'");
...
$package_option_result = $sql_command->select("$database_order_history,$database_package_info,$database_packages","$database_order_history.id,
										   ...
										   $database_order_history.d_","WHERE 
										   $database_order_history.order_id='".addslashes($_POST["invoice_id"])."' and 
										   $database_order_history.item_type='Package' and
										   $database_order_history.type_id=$database_package_info.id and 
...
$menu_option_result = $sql_command->select("$database_order_history,$database_menus,$database_menu_options","$database_order_history.id,
										   ...
										   $database_order_history.type='Included'");
...
if($menu_option_record[10] == "Amount" and $menu_option_record[9] >= 0.01) {
$adjustment_iw = $menu_option_record[4] + $menu_option_record[9];
} elseif($menu_option_record[10] == "Percent" and $menu_option_record[9] >= 0.01) {
...
if($menu_option_record[12] == "Amount" and $menu_option_record[9] >= 0.01) {
$adjustment_iw = $menu_option_record[4] - $menu_option_record[9];
} elseif($menu_option_record[12] == "Percent" and $menu_option_record[9] >= 0.01) {
$percent_value = ($menu_option_record[4] / 100);
$adjustment_iw = $menu_option_record[4] - ($percent_value * $menu_option_record[9]);
} 
...
$package_option_result2 = $sql_command->select("$database_order_history,$database_package_extras","$database_order_history.id,
										   $database_order_history.name,
										   $database_order_history.qty,
										   $database_order_history.cost,
										   $database_order_history.iw_cost,
										   ...
										   $database_order_history.type_id=$database_package_extras.id and 
										   $database_order_history.type='Included'");
...
if($package_option_record2[10] == "Amount" and $package_option_record2[9] >= 0.01) {
$adjustment_iw = $package_option_record2[4] + $package_option_record2[9];
} elseif($package_option_record2[10] == "Percent" and $package_option_record2[9] >= 0.01) {
...
if($package_option_record2[12] == "Amount" and $package_option_record2[9] >= 0.01) {
$adjustment_iw = $package_option_record2[4] - $package_option_record2[9];
} elseif($package_option_record2[12] == "Percent" and $package_option_record2[9] >= 0.01) {
$percent_value = ($package_option_record2[4] / 100);
$adjustment_iw = $package_option_record2[4] - ($percent_value * $package_option_record2[9]);
} 
...
if($package_option_record[10] == "Amount" and $package_option_record[9] >= 0.01) {
$adjustment_iw = $package_option_record[4] + $package_option_record[9];
} elseif($package_option_record[10] == "Percent" and $package_option_record[9] >= 0.01) {
...
if($package_option_record[12] == "Amount" and $package_option_record[9] >= 0.01) {
$adjustment_iw = $package_option_record[4] - $package_option_record[9];
} elseif($package_option_record[12] == "Percent" and $package_option_record[9] >= 0.01) {
$percent_value = ($package_option_record[4] / 100);
$adjustment_iw = $package_option_record[4] - ($percent_value * $package_option_record[9]);
} 
