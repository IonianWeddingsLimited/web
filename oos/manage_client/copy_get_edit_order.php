...
$get_checked_result = $sql_command->select($database_order_history,"qty,d_value,d_type,d_,cost,iw_cost","WHERE order_id='".addslashes($_GET["invoice_id"])."' and type_id='".addslashes($extra_record[0])."' and item_type='Extra' and type='Extra' and (status='Pending' or status='Outstanding')");
$get_checked_record = $sql_command->result($get_checked_result);
...
<input type=\"number\" name=\"extra_cnp_$extra_record[0]\" step=\"any\" value=\"".number_format($get_checked_record[4],2)."\" style=\"width:45px;margin:5px 0px;\" /></div>
<div style=\"float:left; width:60px;\">
<input type=\"number\" name=\"extra_cgp_$extra_record[0]\" step=\"any\" value=\"".number_format($get_checked_record[5],2)."\" style=\"width:45px;margin:5px 0px;\" /></div>
<div style=\"float:left; width:30px; margin:5px;\"><input type=\"text\" name=\"extra_d_value_$extra_record[0]\" value=\"$d_type\" style=\"width:30px;\"></div>
...
<input type=\"number\" name=\"extra_cnp_$extra_record[0]\" step=\"any\" value=\"".number_format($get_checked_record[4],2)."\" style=\"width:45px;margin:5px 0px;\" /></div>
<div style=\"float:left; width:60px;\">
<input type=\"number\" name=\"extra_cgp_$extra_record[0]\" step=\"any\" value=\"".number_format($get_checked_record[5],2)."\" style=\"width:50px;margin:5px 0px;\" /></div>
<div style=\"float:left; width:30px; margin:5px;\"><input type=\"text\" name=\"extra_d_value_$extra_record[0]\" value=\"$d_type\" style=\"width:30px;\"></div>
<div style=\"float:left; margin:5px;\">
><select style=\"width:150px;\" name=\"extra_supplier_$extra_record[0]\">".$supplier_list."
</select>
