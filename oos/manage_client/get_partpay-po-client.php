...
<div style="float:right; margin-top:10px;"><input type="submit" name="action" value="Add Payment To Client" onclick="return checkexchange();"></div>
</form>
...
?>
<div style="float:right; margin-top:10px;"><input type="submit" name="action" value="Modify Payment To Client"></div>
</form>
<form action="<?php echo $site_url; echo $script; ?>" method="get">
<input type="hidden" name="a" value="history" />
<input type="hidden" name="id" value="<?php echo $_GET["id"]; ?>" />
