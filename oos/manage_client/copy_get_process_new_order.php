...
$sql_command->insert($database_order_details, $cols, "'" . addslashes($_POST["client_id"]) . "','" . addslashes($_POST["package_id"]) . "','" . addslashes($package_info_record[0]) . "','" . addslashes($gross_package_cost) . "','" . addslashes($package_info_record[2]) . "','0','0','0','0','$time','0','" . $login_record[1] . "','20.00','" . addslashes($_POST["venue_id"]) . "','" . addslashes($_POST["ceremony_id"]) . "'");
...
'No'";
        ...
        $bespoke_h = ($_POST[$bespoke_hide] == "Yes") ? $sql_command->insert("notes", "note_primary_reference, note_secondary_reference, note_type, extra", "'" . addslashes($maxid) . "','" . addslashes($maxidadd) . "','Hide','Yes'") : $sql_command->delete("notes", "note_primary_reference = '" . addslashes($maxid) . "' and note_secondary_reference = '" . addslashes($maxidadd) . "' and note_type='Hide'");
...
''";
        $sql_command->insert($database_order_history, $cols, $values);
        if ($_POST[$hide] == "Yes") {
            $sql_command->insert("notes", "note_primary_reference, note_secondary_reference, note_type, extra", "'" . addslashes($maxid) . "','" . addslashes($menu_option_record[0]) . "','Hide','Yes'");
        } else {
            $sql_command->delete("notes", "note_primary_reference = '" . addslashes($maxid) . "' and note_secondary_reference = '" . addslashes($menu_option_record[0]) . "' and note_type='Hide'");
        }
    }
...
''";
        $sql_command->insert($database_order_history, $cols, $values);
        if ($_POST[$hide] == "Yes") {
            $sql_command->insert("notes", "note_primary_reference, note_secondary_reference, note_type, extra", "'" . addslashes($maxid) . "','" . addslashes($package_extra_record[0]) . "','Hide','Yes'");
        } else {
            $sql_command->delete("notes", "note_primary_reference = '" . addslashes($maxid) . "' and note_secondary_reference = '" . addslashes($package_extra_record[0]) . "' and note_type='Hide'");
        }
    }
...
$package_info_result = $sql_command->select($database_order_history, "id,name,cost,iw_cost,currency,d_value,d_type,d_", "WHERE order_id='" . addslashes($maxid) . "' and item_type='Package'");
$package_info_record = $sql_command->result($package_info_result);
