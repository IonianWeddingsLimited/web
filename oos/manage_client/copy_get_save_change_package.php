...
$sql_command->update($database_order_history,"iw_cost='".addslashes($gross_package_cost)."'","order_id='".addslashes($_POST["invoice_id"])."' and item_type='Package'");


$sql_command->update($database_order_details,"package_cost='".addslashes($package_info_record[0])."'","id='".addslashes($_POST["invoice_id"])."'");
$sql_command->update($database_order_details,"package_iw_cost='".addslashes($gross_package_cost)."'","id='".addslashes($_POST["invoice_id"])."'");
