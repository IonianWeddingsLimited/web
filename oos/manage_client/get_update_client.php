...
<div style="position:relative;">
	<form action="<?php echo $site_url; ?>/oos/manage-client.php" method="post" name="client">
		...
		<input type="hidden" name="ftype" value="Client" />
...
?>
	...
	new tcal ({
		...
		<div style="float:left; margin:5px;"><input type="text" name="groom_fax" style="width:200px;" value="<?php echo stripslashes($record[29]); ?>"/></div></div>
		<div style="clear:left;"></div>-->
		<hr />
	...
	new tcal ({
		...
		<div style="float:right; margin-top:10px; margin-right:10px;">
			<input type="button" name="" value="Back" onclick="window.location='<?php echo $site_url; ?>/oos/manage-client.php?a=history&id=<?php echo $_GET["id"]; ?>'">
		</div>
...
?>
	<div id="mugshot-wrap">
		...
		echo "<img id=\"mugshot-img\" src=\"".$site_url."/images/imageuploads/mugshot/portrait_placeholder.gif\" width=\"100%\" height=\"100%\" />";
	}
	?>
