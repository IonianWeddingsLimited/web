...
$.get('<?php echo $site_url; ?>/oos/mugshot_view-file-module.php?a=update&id=<?php echo $image_record[0]; ?>&title=' + encodeURIComponent(title) + '&description=' + encodeURIComponent(description) + '&dosavefolder=' + encodeURIComponent(dosavefolder), function(data){
...
$('#results').html();
$.get('<?php echo $site_url; ?>/oos/mugshot_search-module.php?a=search&term=' + encodeURIComponent(term) + '&type=' + encodeURIComponent(type) + '&page=' + encodeURIComponent(page), function(data){
$('#results').html(data);
});
}
...
$('#results').html();
$.get('<?php echo $site_url; ?>/oos/mugshot_search-module.php?a=view&id=' + id + '&term=' + encodeURIComponent(term) + '&type=' + encodeURIComponent(type) + '&page=' + encodeURIComponent(page), function(data){
$('#results').html(data);
});
}
</script>
