...
$sql_command->insert($database_venue_names,"island_id,venue_name,deleted,notes","'".addslashes($_POST["island"])."','".addslashes($_POST["venue_name"])."','No','".addslashes($_POST["venue_note"])."'");

$sql_command->insert($database_client_historyinfo,"client_id,user_id,comment,timestamp,package_id,island_id","'','".$login_record[1]."','Venue Added (".addslashes($_POST["venue_name"]).")','".$time."','','".addslashes($_POST["island"])."'");
...
<textarea name="venue_note" id="venue_note" class="the_editor_min"></textarea><script type="text/javascript">
