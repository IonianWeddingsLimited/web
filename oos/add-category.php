...
$sql_command->insert($database_category_extras,"category_name,deleted","'".addslashes($_POST["name"])."','No'");
$sql_command->insert($database_client_historyinfo,"client_id,user_id,comment,timestamp","'','".$login_record[1]."','Category Added (".addslashes($_POST["name"]).")','".$time."'");
