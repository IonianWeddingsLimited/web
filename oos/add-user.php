...
$sql_command->insert($database_client_historyinfo,"client_id,user_id,comment,timestamp,package_id,island_id","'','".$login_record[1]."','User Added (".addslashes($_POST["username"]).")','".$time."','',''");
...
<p><input type="button" name="" value="Back" onclick="window.location='<?php echo $site_url; ?>/oos/add-user.php'"></p>
<?
$get_template->bottomHTML();
$sql_command->close();
...
<form action="<?php echo $site_url; ?>/oos/add-user.php" method="POST">
