...
if($get_checked_record[1] == "Amount") { $selected = "selected=\"selected\""; } else { $selected = ""; }
} else {
$qty = "0";
$d_type = "0";
$selected = "";
...
<div style=\"float:left; width:60px; margin:5px;\"><input type=\"text\" name=\"menu_d_value_$menu_option_record[0]\" value=\"$d_type\" style=\"width:30px;\"></div>
<div style=\"float:left; width:60px; margin:5px;\"><select name=\"menu_d_type_$menu_option_record[0]\">
...
$cols = "order_id,type_id,name,qty,cost,iw_cost,local_tax_percent,discount_at,discount_percent,currency,item_type,type,status,exchange_rate,timestamp,d_type,d_value";
