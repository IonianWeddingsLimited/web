...
$pdf->Cell(15,4,utf8_decode("£")." ".number_format($january_cost+$february_cost+$march_cost+$april_cost+$may_cost+$june_cost+$july_cost+$august_cost+$september_cost+$october_cost+$november_cost+$december_cost,2),'LR',0,'C',true);
$pdf->Cell(15,4,utf8_decode("£")." ".number_format($january_iwcost+$february_iwcost+$march_iwcost+$april_iwcost+$may_iwcost+$june_iwcost+$july_iwcost+$august_iwcost+$september_iwcost+$october_iwcost+$november_iwcost+$december_iwcost,2),'LR',0,'C',true);
$pdf->Cell(15,4,utf8_decode("£")." ".number_format($january_vat+$february_vat+$march_vat+$april_vat+$may_vat+$june_vat+$july_vat+$august_vat+$september_vat+$october_vat+$november_vat+$december_vat,2),'LR',0,'C',true);
$pdf->Cell(15,4,utf8_decode("£")." ".number_format($january_profit+$february_profit+$march_profit+$april_profit+$may_profit+$june_profit+$july_profit+$august_profit+$september_profit+$october_profit+$november_profit+$december_profit,2),'LR',0,'C',true);
$pdf->Ln(4.1); 
$pdf->Cell(160,0,'','T'); 
$pdf->Ln(0.1);
