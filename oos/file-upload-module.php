...
$list1 .= "<option value=\"".$subfolders_record[0]."\">- ".stripslashes($subfolders_record[2])."</option>\n";
} elseif($subfolders_record[1] == "2x1") {
$list2 .= "<option value=\"".$subfolders_record[0]."\">- ".stripslashes($subfolders_record[2])."</option>\n";
} elseif($subfolders_record[1] == "3x1") {
$list3 .= "<option value=\"".$subfolders_record[0]."\">- ".stripslashes($subfolders_record[2])."</option>\n";
} elseif($subfolders_record[1] == "4x1") {
$list4 .= "<option value=\"".$subfolders_record[0]."\">- ".stripslashes($subfolders_record[2])."</option>\n";
} 
}
...
<p><select name="savefolder" style="width:170px;">
