...
$where = " and $database_clients.iwcuid like '%".addslashes($_GET["keyword"])."%' ";
$orderby = "ORDER BY $database_clients.iwcuid";
} elseif($_GET["key_type"] == "firstname") {
$where = " and ($database_clients.firstname like '%".addslashes($_GET["keyword"])."%' or $database_clients.groom_firstname like '%".addslashes($_GET["keyword"])."%') ";
$orderby = "ORDER BY $database_clients.firstname";
} elseif($_GET["key_type"] == "lastname") {
$where = " and ($database_clients.lastname like '%".addslashes($_GET["keyword"])."%' or $database_clients.groom_surname like '%".addslashes($_GET["keyword"])."%') ";
$orderby = "ORDER BY $database_clients.lastname";
}
	
	
$result = $sql_command->select($database_clients,"$database_clients.id,
							   ...
							   $database_clients.groom_surname","WHERE $database_clients.deleted='No' $where $orderby");
$row = $sql_command->results($result);

foreach($row as $record) {


$result2 = $sql_command->select($database_navigation," $database_navigation.page_name","where $database_navigation.id='".addslashes($record[6])."'");
...
<div style=\"float:left; width:290px; margin:5px;\">".stripslashes($record[1])." ".stripslashes($record[2])." ".stripslashes($record[3])." &amp;<br />".stripslashes($record[7])." ".stripslashes($record[8])." ".stripslashes($record[9])."</div>
<div style=\"float:left; width:200px; margin:5px;\">".stripslashes($record2[0])."</div>
...
<div style="float:left; width:290px; margin:5px;"><strong>Name</strong></div>
...
$result = $sql_command->select($database_clients,"$database_clients.id,
							   ...
							   $database_clients.groom_title,
							   $database_clients.groom_firstname,
							   $database_clients.groom_surname","WHERE deleted='No' ");
$row = $sql_command->results($result);
...
$result = $sql_command->select("$database_clients,$database_navigation,$database_order_details","$database_clients.id,
							   ...
							   $database_clients.groom_title,
							   $database_clients.groom_firstname,
							   $database_clients.groom_surname","WHERE $database_clients.deleted='No' and 
							   $database_clients.destination='".addslashes($_GET["destination_id"])."' and  
...
<div style=\"float:left; width:90px; margin:5px;\"><a href=\"$site_url/oos/manage-client.php?a=history&id=".$record[0]."\">".stripslashes($record[5])."</a></div>
<div style=\"float:left; width:200px; margin:5px;\">".stripslashes($record[1])." ".stripslashes($record[2])." ".stripslashes($record[3])." &amp;<br />".stripslashes($record[8])." ".stripslashes($record[9])." ".stripslashes($record[10])."</div>
...
$result = $sql_command->select("$database_order_details,$database_clients,$database_navigation","$database_clients.id,
							   ...
							   $database_clients.groom_firstname,
							   $database_clients.groom_surname","WHERE $database_clients.deleted='No' and 
							   $database_order_details.id='".addslashes($_GET["order_id"])."' and 
...
$result = $sql_command->select("$database_order_details,$database_clients,$database_navigation,$database_supplier_details,$database_supplier_invoices","$database_clients.id,
							   ...
							   $database_order_details.id","WHERE  $database_clients.deleted='No' and 
							   $database_supplier_details.company_name like '%".addslashes($_GET["supplier_name"])."%' and 
