...
$result = $sql_command->select($database_news,"title,tagline,content,imagename,timestamp,short_url,external_link,overrule,xml_file_name,id","WHERE type='Press' ORDER BY timestamp DESC LIMIT $limitbottom,$per_page");
...
$read_more = "<div onclick=\"return popitup('$site_url/in-the-press/article/$record[5]')\"><h4><a href=\"$site_url/in-the-press/article/$record[5]/\">Read more &gt;</a></h4></div>";
...
$number_rows = $sql_command->count_rows($database_news,"id","type='Press' ORDER BY timestamp DESC");
...
$pagehtml .= "<li class=\"paginationlink\"><a href=\"$site_url/in-the-press/$eachpage\" target=\"_self\" title=\"$eachpage\">$eachpage</a></li>";
}
}
...
if($page != 1) {
$previd = $page-1;
$prev_link = "<li class=\"previouslink\"><a href=\"$site_url/in-the-press/".$previd."\" target=\"_self\" title=\"&lt; Previous;\">&lt; Previous</a></li>";
}

if($page !=$newpage) {
$nextid = $page+1;
$next_link = "<li class=\"nextlink\"><a href=\"$site_url/in-the-press/".$nextid."\" target=\"_self\" title=\"Next &gt;\">Next &gt;</a></li>";
}
