...
$result = $sql_command->select($database_news,"title,tagline,content,imagename,timestamp,short_url,external_link,overrule,xml_file_name,id","WHERE type='News' and timestamp > $last12months ORDER BY timestamp DESC LIMIT $limitbottom,$per_page");
...
$pagehtml .= "<li class=\"paginationlink\"><a href=\"$site_url/latest-news/$eachpage\" target=\"_self\" title=\"$eachpage\">$eachpage</a></li>";
}
}
...
if($page != 1) {
$previd = $page-1;
$prev_link = "<li class=\"previouslink\"><a href=\"$site_url/latest-news/".$previd."\" target=\"_self\" title=\"&lt; Previous;\">&lt; Previous</a></li>";
}

if($page !=$newpage) {
$nextid = $page+1;
$next_link = "<li class=\"nextlink\"><a href=\"$site_url/latest-news/".$nextid."\" target=\"_self\" title=\"Next &gt;\">Next &gt;</a></li>";
}
