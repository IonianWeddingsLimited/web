<form action="" class="pageform" id="weddingquestionnaire" method="post" name="weddingquestionnaire">
	<div class="formheader">
		<h1>Wedding Questionnaire </h1>
		<p>If you are interested in a dream wedding in Greece or Cyprus, please fill in our Wedding Questionnaire. It is designed to help us fully understand your requirements and enable us to make the best suggestions for your big day.</p>
		<p>Please only submit this form if you are genuinely interested in getting married in the Greek islands and are happy to be contacted by Ionian Weddings. We will contact you within 48 hours and also call you back at your preferred date and time to dicsuss your ideas further if requested.</p>
	</div>
	<div class="formheader">
	...
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_bride_firstname" name="weddingquestionnaire_bride_firstname" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_bride_lastname" name="weddingquestionnaire_bride_lastname" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_bride_email" name="weddingquestionnaire_bride_email" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_bride_tel" name="weddingquestionnaire_bride_tel" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_bride_nationality" name="weddingquestionnaire_bride_nationality" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<select class="formselectlong" id="weddingquestionnaire_bride_countryofresidenceID" name="weddingquestionnaire_bride_countryofresidenceID">
				...
				<option value="95">Hong Kong S.A.R.</option>
				...
				<option value="124">Macau S.A.R.</option>
	...
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_groom_firstname" name="weddingquestionnaire_groom_firstname" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_groom_lastname" name="weddingquestionnaire_groom_lastname" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_groom_tel" name="weddingquestionnaire_groom_tel" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_groom_email" name="weddingquestionnaire_groom_email" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_groom_nationality" name="weddingquestionnaire_groom_nationality" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
	...
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_address_1" name="weddingquestionnaire_address_1" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_address_2" name="weddingquestionnaire_address_2" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_address_3" name="weddingquestionnaire_address_3" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_town" name="weddingquestionnaire_town" value="" />
		</div>
		<div class="clear"></div>
	</div>
	...
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_postcode" name="weddingquestionnaire_postcode" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	...
	<div class="formrow">
		<table border="0" class="checkboxblock" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td><input class="formcheckbox" id="weddingquestionnaire_corfu" name="weddingquestionnaire_corfu" type="checkbox" value="Y" /> Corfu</td>
				<td><input class="formcheckbox" id="weddingquestionnaire_lefkada" name="weddingquestionnaire_lefkada" type="checkbox" value="Y" /> Lefkada</td>
				<td><input class="formcheckbox" id="weddingquestionnaire_amorgos" name="weddingquestionnaire_amorgos" type="checkbox" value="Y" /> Amorgos</td>
				<td><input class="formcheckbox" id="weddingquestionnaire_mykonos" name="weddingquestionnaire_mykonos" type="checkbox" value="Y" /> Mykonos</td>
				<td><input class="formcheckbox" id="weddingquestionnaire_santorini" name="weddingquestionnaire_santorini" type="checkbox" value="Y" /> Santorini</td>
			</tr>
			<tr>
				<td><input class="formcheckbox" id="weddingquestionnaire_ithaki" name="weddingquestionnaire_ithaki" type="checkbox" value="Y" /> Ithaki</td>
				<td><input class="formcheckbox" id="weddingquestionnaire_paxos" name="weddingquestionnaire_paxos" type="checkbox" value="Y" /> Paxos</td>
				<td><input class="formcheckbox" id="weddingquestionnaire_crete" name="weddingquestionnaire_crete" type="checkbox" value="Y" /> Crete</td>
				<td><input class="formcheckbox" id="weddingquestionnaire_rhodes" name="weddingquestionnaire_rhodes" type="checkbox" value="Y" /> Rhodes</td>
				<td><input class="formcheckbox" id="weddingquestionnaire_skiathos" name="weddingquestionnaire_skiathos" type="checkbox" value="Y" /> Skiathos</td>
			</tr>
			<tr>
				<td><input class="formcheckbox" id="weddingquestionnaire_kefalonia" name="weddingquestionnaire_kefalonia" type="checkbox" value="Y" /> Kefalonia</td>
				<td><input class="formcheckbox" id="weddingquestionnaire_zakynthos" name="weddingquestionnaire_zakynthos" type="checkbox" value="Y" /> Zakynthos</td>
				<td><input class="formcheckbox" id="weddingquestionnaire_kos" name="weddingquestionnaire_kos" type="checkbox" value="Y" /> kos</td>
				<td><input class="formcheckbox" id="weddingquestionnaire_samos" name="weddingquestionnaire_samos" type="checkbox" value="Y" /> Samos</td>
				<td><input class="formcheckbox" id="weddingquestionnaire_cyprus" name="weddingquestionnaire_cyprus" type="checkbox" value="Y" /> Cyprus</td>
			</tr>
		</table>
	</div>
	...
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_date" name="weddingquestionnaire_date" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_guestcount" name="weddingquestionnaire_guestcount" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	...
	<div class="formrow">
		...
		<div class="formelement">
			<select class="formselectlong" id="weddingquestionnaire_typeofceremonyID" name="weddingquestionnaire_typeofceremonyID">
				...
				<option value="4">Greek Orthodox</option>
				<option value="5">Blessing or renewal of vows</option>
			</select>
		</div>
		<div class="clear"></div>
	</div>
	...
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_ceremony" name="weddingquestionnaire_ceremony" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	...
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_reception" name="weddingquestionnaire_reception" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	...
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_budget" name="weddingquestionnaire_budget" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	...
	<div class="formrow">
		...
		<div class="formelement">
			<textarea class="formtextarealong" col="30" id="weddingquestionnaire_comments" name="weddingquestionnaire_comments" rows="5"></textarea>
		</div>
		<div class="clear"></div>
	</div>
	...
	<div class="formrow">
		...
		<div class="formelement">
			<select class="formselectlong" id="weddingquestionnaire_marketingID" name="weddingquestionnaire_marketingID">
                ...
                <option value="2">Wedding Show Earls Court</option>
                <option value="3">Wedding Show NEC</option>
                <option value="4">Mamma Mia West End</option>
                <option value="5">Daily Express</option>
                <option value="6">Woman's Own</option>
                <option value="7">The Telegraph</option>
                <option value="8">The Times</option>
                <option value="9">The Independent</option>
                <option value="10">Google</option>
                <option value="11">MSN</option>
                <option value="12">Agni</option>
                <option value="13">Other Search Engine</option>
                <option value="14">Trip Advisor</option>
                <option value="15">Greek Islands Club/Sunvil</option>
                <option value="16">Weddings &amp; Honeymoons Abroad</option>
                <option value="17">Travel Weekly</option>
                <option value="18">You and Your Wedding</option>
                <option value="19">Recommendation</option>
			</select>
		</div>
		<div class="clear"></div>
	</div>
	...
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_recommendation" name="weddingquestionnaire_recommendation" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	...
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formcheckbox" id="weddingquestionnaire_callback" name="weddingquestionnaire_callback" type="checkbox" value="Y" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="weddingquestionnaire_callbackdate" name="weddingquestionnaire_callbackdate" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<select class="formselectlong" id="weddingquestionnaire_callbacktimeID" name="weddingquestionnaire_callbacktimeID">
                ...
                <option value="3">14:00 - 17:30</option>
	...
	<div class="formrow">
		...
		<div class="formelement">
			<select class="formselectlong" id="weddingquestionnaire_bookingtimeID" name="weddingquestionnaire_bookingtimeID">
                ...
                <option value="4">Within 6 months</option>
				<option value="4">Later than 6 months</option>
			</select>
		</div>
		<div class="clear"></div>
	</div>
	...
	<div class="formrow">
		...
		<div class="formelement">
			<input name="weddingquestionnaire_callback" type="checkbox" class="formcheckbox" id="weddingquestionnaire_callback" value="Y" checked />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
