<form action="" class="pageform" id="contactus" method="post" name="contactus">
	<div class="formheader">
		<h1>Invoices</h1>
		<p>
			<strong>Ionian Weddings Ltd.</strong><br />
			9 Prado Path<br />
			Twickenham<br />
			TW1 4BB<br />
			England<br />
		...
		<p>Our opening hours are <strong>Monday to Friday 09:00-17.30</strong> except bank holidays.</p>
 		<p>Please note: This form is for general queries only. If you are interested in a quotation for a wedding in Greece or Cyprus, please fill out our <a href="?PTID=8" target="_self" title="Wedding Questionnaire">Wedding Questionnaire</a> first. This will help us understand your requirements about your dream wedding in the Greek islands better.</p>
	</div>
	<div class="formheader">
