<form action="" class="pageform" id="contactus" method="post" name="contactus">
	<div class="formheader">
		<h1>Personal Consultations</h1>
		<p>Ionian Weddings offers a unique personal consultation service for your wedding in Greece or Cyprus.  The consultations are totally tailored to your personal requirements and ideas.  Meetings last up to 2 hours and you'll have the undivided attention of one of our expert wedding planners.  These consultations are particularly useful for:</p>
		<ul>
			<li>Choosing the right island and location for your wedding in Greece or Cyprus</li>
			<li>Viewing our galleries of photos and albums from the different locations</li>
			<li>Browsing menus from different restaurants and tavernas</li>
			<li>Learning more about the islands, where to stay, what to do</li>
			<li>Asking as many questions as you would like!</li>
		</ul> 
		<p>Personal consultations take place on weekdays and selected Saturdays throughout the year and do get booked up quickly.  They take place at our offices in Twickenham (south west London), but we can also arrang meetings in central London. A small charge applies to the consultations which is taken off the cost of your wedding when you book with us.</p>
		<p>Please contact us for more details using the form below to book your consultation.</p>
	</div>
	<div class="formheader">
	...
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="contactus_firstname" name="contactus_firstname" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="contactus_lastname" name="contactus_lastname" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="contactus_email" name="contactus_email" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="contactus_tel" name="contactus_tel" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="contactus_address_1" name="contactus_address_1" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="contactus_address_2" name="contactus_address_2" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="contactus_address_3" name="contactus_address_3" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="contactus_town" name="contactus_town" value="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="formrow">
	...
	<div class="formrow">
		...
		<div class="formelement">
			<input class="formtextfieldlong" id="contactus_postcode" name="contactus_postcode" type="text" value="" />
		</div>
		<div class="clear"></div>
	</div>
	...
	<div class="formrow">
		...
		<div class="formelement">
			<textarea class="formtextarealong" col="30" id="contactus_comments" name="contactus_comments" rows="5"></textarea>
		</div>
		<div class="clear"></div>
	</div>
